      ...
      <div class="MainAsset--content">
        ...
        <div class="MainAsset--ownerInfo text-grey-web">
          ...
          <a
            ...
            href="https://opensea.io/${getNestedObject(mainAsset, ['asset_contract', 'address'])}"
          >
            ${
              getNestedObject(mainAsset, ["asset_contract"])
                ? mainAsset.asset_contract
                  ? truncate(mainAsset.asset_contract.address, 12)
                  : ""
                : "N/A"
            }
          </a>
