      ...
      <div class="answerCol cryptoAnswerCol">
        <div class="answerRow">
          ...
          <div class="mainCol1">
            ...
            ${
              last_updated
                ? `<p class="priceLabel textGray">Last updated on ${new Date(
                    last_updated
          ...
          <div class="sideCol cryptoSideContain">
            ${
              market_cap_rank
                ? `<h3 class="rank">Ranked <span class="ranking">${market_cap_rank}</span> by CoinGecko</h3>`
                : ``
            }
              ...
              ${
                market_cap.usd
                  ? `<div class="priceItem">
                    ...
                    )} <span class="textGray400">USD</span></h1>
                  </div>`
                  : ``
              }
              ${
